  ...
  const steps = [
    {
      ...
      text: "Start tracking instantly using your unique shipment ID.",
    },
    {
      Icon: RocketIcon,
      title: "Track your Order",
      text: "Get real-time updates for safe and secure deliveries.",
    },
    {
      Icon: FireTruckIcon,
      title: "Order in Transit",
      text: " Know exactly when your courier is on the move.",
    },
    {
      Icon: StarIcon,
      title: "Successful Delivery",
      text: "Receive confirmation once your parcel reaches its destination.",
    },
  ];
  ...
  return (
    ...
    >
      <Box position="relative" zIndex={1}>
        ...
        >
          How to Track Your Courier - Bharat Parcel
        </Typography>
        ...
        >
          Easily monitor your shipment with our real-time tracking system. Stay updated at every step and enjoy full transparency until delivery.
        </Typography>
