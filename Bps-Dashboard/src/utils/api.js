...
//upload image url
export const FILES_BASE_URL = 'https://api.bharatparcel.org';         //https://api.bharatparcel.org/

export const WHATSAPP_API = 'https://api.bharatparcel.org/api/whatsapp';   //https://api.bharatparcel.org/api/whatsapp
